  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="<?php echo site_url("categories/agregar_categoria") ?>">
  ...
  <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="<?php echo site_url("categories/editar_categoria
        ") ?>">
          <div class="modal-body">
...
<script type="text/javascript">
  function get_datos_categoria(idCategoria) {
    ...
    $.post( "<?= base_url('categories/datos_categoria')?>", { idCategoria: idCategoria }, function( data ) {
  ...
  function eliminar_categoria(idCategoria){
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.post( "<?= base_url('categories/eliminar_categoria')?>", { idCategoria: idCategoria }, function( data ) {
            console.log(data)
