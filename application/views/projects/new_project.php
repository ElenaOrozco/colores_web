        ...
        <div class="card">
            <div class="card-header">
              ...
              <div class="card-body pb-5">
                ...
                <form role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="<?php echo site_url("projects/insert_project") ?>">
                    <div class="modal-body row">
                        <div class="col-offset-md-3 col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Image Before</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Image After</label>
